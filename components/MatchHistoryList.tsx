            ...
            <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl max-h-[80vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
                <div className="p-6 border-b flex items-center justify-between bg-slate-50">
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            onClick={handleShare}
                            className={`px-3 py-1.5 rounded-xl flex items-center gap-1.5 text-xs font-bold transition-all shadow-sm ${currentUser ? 'bg-[#00C300] text-white hover:bg-[#00b300]' : 'bg-slate-100 text-slate-600 hover:bg-slate-200'}`}
                        >
                            {currentUser ? (
                                <>
